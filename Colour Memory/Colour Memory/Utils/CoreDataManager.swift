...
class CoreDataManager {
    ...
    private lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "Colour_Memory", withExtension: "momd")!
    ...
    private lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let url = self.applicationDocumentsDirectory.appendingPathComponent("Colour_Memory.sqlite")
